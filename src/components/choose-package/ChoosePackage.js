      ...
      <div className="bg-white mx-auto p-5">
        ...
        <div className="mb-8 mt-8">
          <div
            ...
            className={`p-8 border-2 border-black text-sm rounded-2xl cursor-pointer mb-8 ${
          ...
          <div
            ...
            className={`p-8 border-2 border-black text-sm rounded-2xl ${
        ...
        <div className="text-sm">
          ราคาทั้งหมด {selectedPackage === PACKAGE.THREE ? "999" : "1,999"} บาท
        </div>
        <Button
          className="w-full bg-yellow-400 hover:bg-color-600 cursor-pointer text-white border-none mt-16 rounded-lg hover:bg-yellow-600"
          onClick={() => {
